...
export const useGetDefaultAwards = () => {
  ...
  const defaultCategories = useMemo(
    () => [
      ...
      t('awards.defaultCategories.bestCommunitySupport'),
      t('awards.defaultCategories.bestIndie'),
      t('awards.defaultCategories.bestDebutIndie'),
      t('awards.defaultCategories.bestMobile'),
      t('awards.defaultCategories.bestVR'),
      ...
      t('awards.defaultCategories.bestEsportGame'),
    ],
    [t],
  );
