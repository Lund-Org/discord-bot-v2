...
const STATUS: BacklogGame['status'] = 'WISHLIST';
...
export const WishlistSection = () => {
  ...
  if (games.length === 0) {
    return (
      <EmptyPlaceholder title={t('myBacklog.placeholder.wishlist.title')} />
    );
  }
      ...
      <Flex flexDir="column" gap={2} mt={6}>
        <Box w="100%" overflowX="auto" position="relative" px="8px">
          ...
          >
            ...
            <GridItem>{t('myBacklog.wishlistedAt')}</GridItem>
                ...
                <Fragment key={game.id}>
                  ...
                  <GridItem>
                    <Text fontSize={14} fontWeight={600}>
                      {game.wishlistAt
                        ? format(new Date(game.wishlistAt), 'dd/MM/yyyy')
                        : null}
                    </Text>
                  </GridItem>
                  <GridItem>
