...
export const AbandonedSection = () => {
  ...
  if (games.length === 0) {
    return (
      <EmptyPlaceholder
        title={t('myBacklog.placeholder.abandoned.title')}
        description={t('myBacklog.placeholder.abandoned.description')}
      />
    );
  }
      ...
      <Flex flexDir="column" gap={2} mt={6}>
        <Box w="100%" overflowX="auto" position="relative" px="8px">
          ...
          >
            ...
            <GridItem>{t('myBacklog.abandonedAt')}</GridItem>
                ...
                <Fragment key={game.id}>
                  ...
                  <GridItem>
                    <Text fontSize={14} fontWeight={600}>
                      {game.abandonedAt
                        ? format(new Date(game.abandonedAt), 'dd/MM/yyyy')
                        : null}
                    </Text>
                  </GridItem>
                  <GridItem>
