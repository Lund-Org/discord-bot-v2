...
export const TodoSection = ({
  ...
  if (games.length === 0) {
    return (
      <EmptyPlaceholder
        title={t('myBacklog.placeholder.backlog.title')}
        description={t('myBacklog.placeholder.backlog.description')}
      >
        <Button onClick={openAddGameModal} colorScheme="teal">
          {t('myBacklog.placeholder.backlog.button')}
        </Button>
      </EmptyPlaceholder>
    );
  }
  ...
  return (
    <Flex flexDir="column" gap={2}>
      ...
      <Flex flexDir="column" gap={2} mt={6}>
        <Box w="100%" overflowX="auto" position="relative" px="8px">
          ...
          >
            ...
            <GridItem>{t('myBacklog.addedThe')}</GridItem>
      ...
      <ChangeStateModal
        ...
        values={[STATUS, 'CURRENTLY', 'FINISHED', 'ABANDONED', 'WISHLIST']}
      />
      <NoteModal
